...
Each entry in the JSON should have the following structure: I want this json as a string and output only this string nothing else.
{
...
def generate_highlights(transcription):
    try:
        ...
        if not highlight_response:
            ...
            try:
                data_json = json.loads(highlight_response)
                return data_json
